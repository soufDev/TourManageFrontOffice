 ...
 */
public class MyBaseAdapterTourneeJour extends BaseAdapter {
TextView idClient;
    ...
    public MyBaseAdapterTourneeJour(Context context, ArrayList<CommandeClient> myList) {
        this.myList = myList;
...
/*Cette méthode permet de connaître le nombre d'items présent dans la liste*/
    ...
    public CommandeClient getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btntour.setOnClickListener(new View.OnClickListener() {
            ...
            CommandeClient currentListData = getItem(position);

            int colorPos = position % colors.length;
            convertView.setBackgroundColor(colors[colorPos]);
            mViewHolder.client.setText(String.valueOf(currentListData.getIdClient()));
            mViewHolder.adresse.setText(currentListData.getNomClient());
            mViewHolder.motif.setText(currentListData.getMotifVisite());
            mViewHolder.statut.setText(String.valueOf(currentListData.getIdCommande()));
           // mViewHolder.idLiv.setText(String.valueOf(currentListData.getIdLivraison()));
            return convertView;
